...
\begin{figure}[ht]
\centering
\includegraphics[width=0.65\textwidth]{false_positive_yolo.jpg}
\caption{Example false positive: a person misclassified as a yellow cone by the baseline YOLO11n detector.}
...
\begin{enumerate}
    ...
    \item Evaluate more modern YOLO architectures (YOLO12n, YOLO26n)
