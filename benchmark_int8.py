#!/usr/bin/env python3
"""
Benchmark INT8 vs FP32 inference speed and accuracy.
...
os.environ['WANDB_NAME'] = 'YOLO12n_INT8_benchmark'
...
print("=" * 70)
print("STEP 3: BENCHMARK INT8 vs FP32")
print("=" * 70)
print()

# Model paths
fp32_path = 'runs/detect/runs/yolo12/yolo12n_300ep_FSOCO2/weights/best.pt'
int8_path = 'runs/detect/runs/yolo12/yolo12n_300ep_FSOCO2/weights/best.engine'

# Check if INT8 model exists
if not Path(int8_path).exists():
    print(f"❌ ERROR: INT8 model not found at {int8_path}")
    print("   Run export_tensorrt_int8.py first!")
    exit(1)
...
print(f"  FP32: ~{rtx4060_fp32:.2f} ms")
print(f"  INT8: ~{rtx4060_int8:.2f} ms")
print()
